...
//     version 1.11.1
//     from Assets/Scripts/Player/SpaceshipControl/PlayerControl.inputactions
//
...
public partial class @PlayerControl: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_PlayerNormal_Crosshair = m_PlayerNormal.FindAction("Crosshair", throwIfNotFound: true);
        // UI
    ...
    ~@PlayerControl()
    {
        UnityEngine.Debug.Assert(!m_PlayerNormal.enabled, "This will cause a leak and performance issues, PlayerControl.PlayerNormal.Disable() has not been called.");
    ...
    private readonly InputAction m_PlayerNormal_Crosshair;
    public struct PlayerNormalActions
    {
        ...
        public InputAction @Crosshair => m_Wrapper.m_PlayerNormal_Crosshair;
